...
//   const save = arr1.slice(1,-2);
//   const arr3 = save.concat(arr2);
...
// calcAverageAge([16, 6, 10, 5, 6, 1, 4]);
...
// // const save = dogs.slice().sort((a, b) => a.recommendedFood - b.recommendedFood);
// // console.log(save);
// const randomInt = (min, max) =>
//   Math.trunc(Math.random() * (max - min) + 1) + min;

// console.log(randomInt(-26, -24));
